...
class OpenAICompatibleClient:
    ...
    async def generate(self, user_input: str) -> LLMResponse:
        ...
        message = [{"role": "user", "content": user_input}, {"role": "system", "content": system_prompt}]
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        if llm_output.subtasks:
            sub_task_msg = []
            for subtask in llm_output.subtasks:
                ...
                if available_tools.get(tool_args.name):
                    ...
                    sub_task_msg.append({"role": "tool", "content": observation, "tool_call_id": tool_args.id})
