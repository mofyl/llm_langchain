...
class HelloAgentsLLM:
    ...
    def _resolve_credentials(self, api_key: str | None, base_url: str | None) -> tuple[str | None, str | None]:
        ...
        if self.provider == "openai":
            ...
            resolved_base_url = (
                base_url or os.getenv("LLM_BASE_URL") or "https://dashscope.aliyuncs.com/compatible-mode/v1"
            )
            return resolved_api_key, resolved_base_url
            ...
            resolved_api_key = (
                api_key or os.getenv("KIMI_API_KEY") or os.getenv("MOONSHOT_API_KEY") or os.getenv("LLM_API_KEY")
            )
            ...
            resolved_api_key = (
                api_key or os.getenv("ZHIPU_API_KEY") or os.getenv("GLM_API_KEY") or os.getenv("LLM_API_KEY")
            )
